    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enrolado', models.BooleanField(default=False, verbose_name='Tiene rol en la organización')),
                ('imagen', models.ImageField(blank=True, null=True, upload_to=medica_app.models.user_directory_path, verbose_name='Imagen')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('AG', 'AGENDADA'), ('AT', 'ATENDIDA'), ('CA', 'CANCELADA'), ('NA', 'NO ATENDIDA')], default='AGENDADA', editable=False, max_length=20, verbose_name='Estado de la cita')),
